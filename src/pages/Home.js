...
export default class Home extends Component {
	constructor() {
		...
		this.state = {
			disheClassify: {
				...
				西餐分类: [ '法式菜肴', '英式菜肴', '意式菜肴', '美式菜肴', '俄式菜肴' ],
				厨房用具: [ '储藏用具', '洗涤用具', '调理用具', '烹调用具', '进餐用具' ],
	...
	onOpenChange = (type) => {
		...
		if (type && chooseClassify && chooseClassify !== type && this.state.open) {
			setTimeout(() => {
				this.setState({
					currentClassify: disheClassify[type],
					open: !this.state.open
		...
		return (
			<div className="home-main">
				...
				<div className="home-conent">
					<ChooseType onOpenChange={this.onOpenChange} />
